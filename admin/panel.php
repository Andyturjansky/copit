    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="panel.php?modulo=editarUsuario&IdUsuario=<?php echo $_SESSION['IdUsuario']; ?>" class="dropdown-item">
            <i></i> Editar perfil            
       </a>                   
      </li>  
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="panel.php?modulo=estadisticas" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">COPIT</span>
    </a>
...
<script>
  $(document).ready(function () {
    $(".BorrarUsuario").click(function (e) { 
      e.preventDefault();
      var res=confirm("¿Estas seguro de que quieres borrar este usuario?");
      if(res==true){
...
<script>
  $(document).ready(function () {
    $(".VerificarProducto").click(function (e) { 
      e.preventDefault();
      var res=confirm("¿Estas seguro de que quieres verificar este producto?");
      if(res==true){
        var Link=$(this).attr("href");
        window.location=Link;
      }
