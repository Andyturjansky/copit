...
<body>
    ...
    if ($res) {
        echo '<meta http-equiv="refresh" content="0; url=publicarProducto.php?mensaje=Producto publicado exitosamente"/>  ';        
    } else {
?>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">              
              <!-- /.card-header -->
              <div class="card-body">
              <form action="publicarProducto.php" method="post" enctype="multipart/form-data">                            
